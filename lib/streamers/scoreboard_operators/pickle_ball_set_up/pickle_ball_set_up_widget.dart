...
import 'pickle_ball_set_up_model.dart';
export 'pickle_ball_set_up_model.dart';

class PickleBallSetUpWidget extends StatefulWidget {
  const PickleBallSetUpWidget({super.key});

  @override
  State<PickleBallSetUpWidget> createState() => _PickleBallSetUpWidgetState();
}

class _PickleBallSetUpWidgetState extends State<PickleBallSetUpWidget> {
  late PickleBallSetUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PickleBallSetUpModel());
