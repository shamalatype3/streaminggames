...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF42AE60);
  late Color secondary = const Color(0xFF150000);
  late Color tertiary = const Color(0xFFFAFAFA);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF322D2D);
  late Color secondaryText = const Color(0xFF525252);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFADABAB);
  late Color accent1 = const Color(0xFFF4F4F4);
  late Color accent2 = const Color(0xFF4A9B6F);
